...
public interface BookingService {
    ...
    List<BookingOutDto> getUserBookingsByState(BookingSearchState state, Long userId);

    List<BookingOutDto> getBookingsOnUserItemsByState(BookingSearchState state, Long userId);
}